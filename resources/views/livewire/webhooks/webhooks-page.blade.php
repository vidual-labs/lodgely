<div class="space-y-6 max-w-4xl">
    <div class="flex items-end justify-between gap-4">
        <div>
            <h1 class="text-xl font-semibold text-slate-900 dark:text-slate-50">Webhook endpoints</h1>
                        ...
                        @if($revealedId === $ep->id)
                            <tr wire:key="ep-token-{{ $ep->id }}" class="bg-slate-50 dark:bg-slate-800/40">
                                <td colspan="6" class="px-3 py-3">
                                    <p class="text-xs text-slate-500 dark:text-slate-400 mb-1 font-medium">Webhook URL — keep this secret</p>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 dark:bg-black/60 px-4">
            <div role="dialog" aria-modal="true" aria-labelledby="webhooks-dialog-title"
                ...
                <header class="border-b border-slate-200 dark:border-slate-700/50 px-5 py-3 flex justify-between items-center">
                    <h2 id="webhooks-dialog-title" class="text-base font-semibold text-slate-900 dark:text-slate-50">New webhook endpoint</h2>
                ...
                <form wire:submit.prevent="save" class="px-5 py-4 space-y-3">
                    ...
                    <div>
                        <label class="text-xs font-medium text-slate-600 dark:text-slate-400">Default client name <span class="text-slate-400 dark:text-slate-500">(optional)</span></label>
                    ...
                    <div>
                        <label class="text-xs font-medium text-slate-600 dark:text-slate-400">Default campaign <span class="text-slate-400 dark:text-slate-500">(optional)</span></label>
