<div class="space-y-6 max-w-3xl">
    <div>
        <h1 class="text-xl font-semibold text-slate-900 dark:text-slate-50">CSV import</h1>
    ...
    <form wire:submit.prevent="submit"
        ...
        <div>
            <label class="text-xs font-medium text-slate-600 dark:text-slate-400">CSV file</label>
        ...
        <div class="grid grid-cols-2 gap-3">
            <div>
                <label class="text-xs font-medium text-slate-600 dark:text-slate-400">Default client (optional)</label>
            ...
            <div>
                <label class="text-xs font-medium text-slate-600 dark:text-slate-400">Default campaign (optional)</label>
    ...
    <div>
        <h2 class="text-sm font-semibold text-slate-900 dark:text-slate-50 mb-2">Recent CSV imports</h2>
        <div class="rounded-xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-slate-900 overflow-hidden shadow-sm">
            <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700/50 text-sm">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                    ...
                    @empty
                        <tr><td colspan="5" class="px-3 py-6 text-center text-slate-500 dark:text-slate-400">No CSV imports yet.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
