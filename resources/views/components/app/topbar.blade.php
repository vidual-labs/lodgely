    ...
    <div class="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            ...
            >
                ...
                <svg x-show="dark" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
                ...
                <svg x-show="!dark" viewBox="0 0 24 24" fill="currentColor" class="h-4 w-4">
            ...
            @auth
                <div class="flex items-center gap-3 text-sm">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 transition-colors text-sm">Sign out</button>
                    </form>
                </div>
            @endauth
        </div>
